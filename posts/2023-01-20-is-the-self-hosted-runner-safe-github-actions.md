...
Want to know how actuated works? [Read the FAQ for more technical details](https://docs.actuated.com/faq/).

* [Find a server for your builds](/pricing)
* [Register for actuated](https://docs.actuated.com/provision-server/)
