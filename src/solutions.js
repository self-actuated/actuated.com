...
const features = [
    {
      name: 'Faster E2E',
      description: 'Actuated uses bare metal hosts.',
      href: '#',
      icon: FireIcon,
    },
    {
      ...
      <div id='solutions' className="bg-white py-5 sm:py-5 lg:py-10">
        ...
        <div className="mx-auto mt-5 max-w-xl px-6 lg:max-w-7xl lg:px-8">
          ...
          <dl className="grid grid-cols-1 lg:grid-cols-1">
            <div className='mx-10' key="arm-feature">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                    <p>The Apple M1 has made local developers much more productive. Teams we interviewed told us their code builds in 1-2 minutes locally, but takes more than 30 minutes with GitHub's runners.</p>
        ...
        <div className="mx-auto mt-5 max-w-xl px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className='mx-10' key="isolated-feature">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                    <p>Actuated uses a hybrid model that you bring bare-metal machines with a bare Operating System, and we do everything else.</p>
        ...
        <div className="mx-auto mt-5 max-w-xl px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className='mx-10' key="debug-feature">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                    <p>We heard from many teams that they missed CircleCI's "debug this job" button, so we built it for you.</p>
        ...
        <div className="mx-auto mt-5 max-w-xl px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className='mx-10' key="debug-feature">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                    <p>Most small teams we spoke to were already spending 1000-1500 USD/mo on overages charges on GitHub Actions for the slower hosted runners.</p>
                    <p>This doesn't factor in the long delays that your team is facing, and with engineering salaries at an all time high, we're talking about 100-300 USD / hour for every hour wasted, per person within your team.</p>
